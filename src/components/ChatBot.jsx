          ...
          >
            ...
            <div className="p-6 flex items-center justify-between border-b border-white/5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-luxury text-xl text-white/90 tracking-wide">Jannat Assistant</h3>
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-emerald-500" />
                    <span className="text-[10px] font-medium text-white/40 tracking-wider">Online • Concierge</span>
                  </div>
                </div>
              </div>
                    ...
                    <div className={`px-5 py-4 rounded-3xl text-sm leading-relaxed ${
                      ...
                      {msg.from === 'bot' && i === 0 ? (
                        <div className="space-y-4">
                          <p className="font-luxury text-xl text-white leading-tight">Welcome to Jannat Rugs Co. Luxury Experience. ✨</p>
