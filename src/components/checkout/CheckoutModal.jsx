      ...
      {isCheckoutOpen && (
        <div className="fixed inset-0 z-[10050] flex items-end sm:items-center justify-center">
          ...
          <motion.div
            ...
            className="relative z-10 w-full sm:w-[95%] sm:max-w-[960px] max-h-[94dvh] sm:max-h-[92vh] overflow-y-auto rounded-t-[20px] sm:rounded-[20px] bg-[#FAF7F2] border border-white/60 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.35)]"
          >
