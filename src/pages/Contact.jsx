    ...
    <div className="pt-24 min-h-screen bg-[#FAF7F2]">
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-8 sm:py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-12 sm:gap-20 items-start">
          {/* Form Side */}
          <div className="w-full lg:w-2/3 bg-white p-6 sm:p-16 rounded-[2rem] sm:rounded-[3rem] border border-amber-900/10 shadow-xl">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1A1A1A] mb-2">Send an Inquiry</h2>
            <p className="text-black/40 text-[10px] sm:text-sm mb-8 sm:mb-10 font-medium tracking-wide uppercase">Response within 24 hours</p>
            ...
            <form onSubmit={submit} className="space-y-5 sm:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                <div>
                  ...
                  <input type="text" required value={form.name}
                    ...
                    className="w-full bg-black/5 border border-amber-900/10 rounded-xl sm:rounded-2xl p-3.5 sm:p-4 text-sm font-bold text-[#1A1A1A] outline-none focus:ring-4 focus:ring-[#C9A84C]/10 focus:border-[#C9A84C] transition-all" />
                </div>
                <div>
                  <label className="text-[9px] sm:text-[10px] font-bold text-black/40 uppercase tracking-widest block mb-1.5 sm:mb-2 pl-1">Email Address</label>
              ...
              <div>
                <label className="text-[9px] sm:text-[10px] font-bold text-black/40 uppercase tracking-widest block mb-1.5 sm:mb-2 pl-1">Phone Number</label>
                <input type="tel" value={form.phone}
                  onChange={e => setForm(p => ({ ...p, phone: e.target.value }))}
                  className="w-full bg-black/5 border border-amber-900/10 rounded-xl sm:rounded-2xl p-3.5 sm:p-4 text-sm font-bold text-[#1A1A1A] outline-none focus:ring-4 focus:ring-[#C9A84C]/10 focus:border-[#C9A84C] transition-all" />
              </div>
              <div>
                <label className="text-[9px] sm:text-[10px] font-bold text-black/40 uppercase tracking-widest block mb-1.5 sm:mb-2 pl-1">Your Message</label>
                <textarea rows={5} required value={form.message}
                  onChange={e => setForm(p => ({ ...p, message: e.target.value }))}
                  placeholder="Share your requirements..."
                  className="w-full bg-black/5 border border-amber-900/10 rounded-xl sm:rounded-2xl p-3.5 sm:p-4 text-sm font-bold text-[#1A1A1A] outline-none focus:ring-4 focus:ring-[#C9A84C]/10 focus:border-[#C9A84C] transition-all resize-none" />
              </div>
          ...
          <div className="w-full lg:w-1/3">
             <div className="sticky top-32 space-y-8 sm:space-y-12">
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-[#1A1A1A] mb-4 sm:mb-6">Concierge Support</h3>
                  <p className="text-black/50 text-xs sm:text-sm leading-relaxed mb-6 sm:mb-8">Reach out via our direct WhatsApp channel for bespoke consultations. Available 24/7.</p>
                ...
                <div className="pt-6 sm:pt-8 border-t border-amber-900/10">
                  <h3 className="text-lg sm:text-xl font-bold text-[#1A1A1A] mb-4 sm:mb-6">Visit Our Showroom</h3>
                  <div className="w-full aspect-video rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden border border-amber-900/10 shadow-sm grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
                    <iframe 
