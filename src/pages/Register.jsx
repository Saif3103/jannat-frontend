            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                 <div className="relative">
                    <div className="absolute left-6 top-1/2 -translate-y-1/2 text-[#C9A84C]"><FiUser size={18} /></div>
                 ...
                 <div className="relative">
                    <div className="absolute left-6 top-1/2 -translate-y-1/2 text-[#C9A84C]"><FiPhone size={18} /></div>
              ...
              <div className="relative">
                <div className="absolute left-6 top-1/2 -translate-y-1/2 text-[#C9A84C]"><FiMail size={18} /></div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                 <div className="relative">
                    <div className="absolute left-6 top-1/2 -translate-y-1/2 text-[#C9A84C]"><FiLock size={18} /></div>
